...
icons = {
    "arszi_scout": "ui_inGame2_Put_v_pripyat",
    "arszi_fetch_meat": "ui_inGame2_Pripasi",
    "arszi_fetch_trophy": "ui_inGame2_Trophy",
    "arszi_fetch_hide": "ui_inGame2_Pelt",
    "arszi_fetch_psy_dog_fur": "ui_inGame2_Nochnaya_ohota",
    "arszi_fetch_beak": "ui_inGame2_Crow",
    "arszi_fetch_bloodsucker": "ui_inGame2_Bloodsucker1",
    "arszi_fetch_chimera": "ui_inGame2_PD_Ohotnik_na_mutantov",
    "arszi_fetch_monster_common": "ui_inGame2_Knife",
    "arszi_fetch_zombie": "ui_inGame2_Zombie",
    "arszi_fetch_humanoid": "ui_inGame2_Specimen_Humanoid",
    "arszi_fetch_monster_rare": "ui_inGame2_Specimen_Controller",
}
...
quests = {
    ...
    "BUTCHER": [
        "arszi_fetch_trophy",
        "arszi_fetch_hide",
        "arszi_fetch_psy_dog_fur",
        "arszi_fetch_beak",
        "arszi_fetch_bloodsucker",
        "arszi_fetch_chimera",
    ],
    "COLD": [
        "arszi_scout",
    ...
    "SAKHAROV": [
        "arszi_fetch_monster_common",
        "arszi_fetch_zombie",
        "arszi_fetch_humanoid",
        "arszi_fetch_monster_rare",
    ],
